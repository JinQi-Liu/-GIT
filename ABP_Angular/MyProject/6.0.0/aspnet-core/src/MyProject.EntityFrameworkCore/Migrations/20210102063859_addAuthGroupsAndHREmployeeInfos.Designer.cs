...
namespace MyProject.Migrations
{
    ...
    [Migration("20210102063859_addAuthGroupsAndHREmployeeInfos")]
    partial class addAuthGroupsAndHREmployeeInfos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProject.EntityFrameworkCore.Entity.AuthGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MyProject.EntityFrameworkCore.Entity.AuthGroupEmployeeInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("HREmployeeInfoID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("HREmployeeInfoID");

                    b.ToTable("Auth_GroupEmployeeInfo");
                });

            modelBuilder.Entity("MyProject.EntityFrameworkCore.Entity.HREmployeeInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MyProject.EntityFrameworkCore.Entity.AuthGroupEmployeeInfo", b =>
                {
                    b.HasOne("MyProject.EntityFrameworkCore.Entity.AuthGroup", "AuthGroup")
                        .WithMany("AuthGroupEmployeeInfos")
                        .HasForeignKey("AuthGroupID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyProject.EntityFrameworkCore.Entity.HREmployeeInfo", "HREmployeeInfo")
                        .WithMany("AuthGroupEmployeeInfos")
                        .HasForeignKey("HREmployeeInfoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AuthGroup");

                    b.Navigation("HREmployeeInfo");
                });
            ...
            modelBuilder.Entity("MyProject.EntityFrameworkCore.Entity.AuthGroup", b =>
                {
                    b.Navigation("AuthGroupEmployeeInfos");
                });
